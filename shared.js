...
<header id="siteHeader" class="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur-sm transition-all duration-300 h-20">
  <div class="container max-w-[1400px] mx-auto flex h-full items-center justify-between px-4 md:px-8">
    ...
    <div class="flex items-center gap-2 xl:gap-4">
      <a href="https://form.jotform.com/261857146006154" class="hidden lg:inline-flex items-center justify-center bg-primary text-primary-foreground hover:bg-primary/90 rounded-lg px-6 py-2.5 text-sm font-semibold whitespace-nowrap transition">Apply Now</a>
...
<div id="mobileMenu" class="fixed inset-0 z-[100] hidden">
  <div class="absolute inset-0 bg-primary text-primary-foreground overflow-y-auto">
    ...
    <div class="px-6 pt-7 pb-2 space-y-3">
      <a href="https://form.jotform.com/261857146006154" class="flex items-center justify-center gap-2 w-full bg-accent text-primary text-center font-bold text-base py-4 rounded-full shadow-lg">
        Apply Now
  ...
  function productLinks(){
    return [
      ...
      { label:'Revenue Advance', href:'merchant-cash-advance.html' },
