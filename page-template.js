  ...
  <div class="relative container mx-auto px-4 md:px-6 pt-10 md:pt-14 pb-20 md:pb-32">
    ...
    <div class="max-w-3xl text-primary-foreground reveal-l">
      ...
      <div class="flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
        <a href="${(typeof p!=='undefined'&&p&&p.slug==='merchant-cash-advance')?'https://form.jotform.com/261271610738051':'https://form.jotform.com/261857146006154'}" class="inline-flex items-center justify-center bg-accent text-primary hover:bg-white rounded-full px-9 py-4 text-base font-bold transition-all">
          Pre-qualify
  ...
  <div class="container mx-auto px-4 md:px-6 relative">
    <div class="grid md:grid-cols-12 gap-12 items-center">
      ...
      <div class="md:col-span-5 flex flex-col gap-3 md:items-end">
        <a href="${(typeof p!=='undefined'&&p&&p.slug==='merchant-cash-advance')?'https://form.jotform.com/261271610738051':'https://form.jotform.com/261857146006154'}" class="inline-flex items-center justify-center bg-accent text-primary hover:bg-accent/90 rounded-full px-10 py-5 text-lg font-bold w-full md:w-auto">
          Apply Now
    ...
    <div class="grid md:grid-cols-12 gap-10 md:gap-12 lg:gap-16 items-stretch">
      ...
      <div class="md:col-span-6 lg:col-span-7 flex flex-col justify-center reveal py-4 md:py-12 lg:py-16">
        ...
        <div class="flex flex-col sm:flex-row sm:items-center gap-5">
          <a href="${(typeof p!=='undefined'&&p&&p.slug==='merchant-cash-advance')?'https://form.jotform.com/261271610738051':'https://form.jotform.com/261857146006154'}" class="inline-flex items-center justify-center bg-accent hover:bg-accent/90 text-primary font-bold px-8 py-4 text-base shadow-xl shadow-accent/20 transition-all hover:scale-[1.02] rounded-full">
            Pre-qualify
          </a>
    ...
    <div class="border-t border-border/70 pt-8 md:pt-10">
      <div class="grid md:grid-cols-12 gap-x-10 gap-y-8 items-center">
        ...
        <div class="md:col-span-2 reveal flex md:justify-end" data-delay="180">
          <a href="${(typeof p!=='undefined'&&p&&p.slug==='merchant-cash-advance')?'https://form.jotform.com/261271610738051':'https://form.jotform.com/261857146006154'}" class="inline-flex items-center gap-2 text-primary font-bold border-b-2 border-accent pb-1 hover:gap-3 transition-all text-sm whitespace-nowrap">
            Pre-qualify
  ...
  <div class="container mx-auto px-4 md:px-6">
    <div class="max-w-5xl mx-auto">
      ...
      <div id="credit-report-submit" class="grid md:grid-cols-2 gap-px bg-border/60 border border-border/60 rounded-2xl overflow-hidden scroll-mt-24">
        <a href="${(typeof p!=='undefined'&&p&&p.slug==='merchant-cash-advance')?'https://form.jotform.com/261271610738051':'https://form.jotform.com/261857146006154'}" class="group bg-primary text-white p-8 md:p-10 flex flex-col gap-4 hover:bg-primary/95 transition-colors">
