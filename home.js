...
(function(){
  const products = [
    ...
    { title:"Revenue Advance", icon:"trending", slug:"merchant-cash-advance", description:"Get an advance on future revenue. Perfect for quick cash flow needs with flexible repayment.",
  ...
  const flexPills = ['Term Loans','Revenue Advance','Business Line Of Credit','Credit Stacking','SBA Loans','Real Estate Loan','Personal Term Loans'];
