    ...
    <div class="mt-20 md:mt-24 grid md:grid-cols-12 gap-10 md:gap-12 items-center">
      ...
      <div class="md:col-span-5 reveal" data-delay="120">
        ...
        <div class="flex flex-col sm:flex-row gap-4">
          <a href="https://form.jotform.com/261857146006154" class="inline-flex items-center justify-center bg-accent hover:bg-accent/90 text-primary font-bold px-8 py-4 rounded-full shadow-xl shadow-accent/20 transition-all hover:scale-105">Pre-qualify now</a>
...
<section class="py-16 md:py-20">
  ...
  window.LendiagoRenderFAQ = function(){
    ...
    const faqs = [
      ['What types of business funding does Lendiago offer?','We offer seven tailored products: Business Term Loans, Revenue Advances, Business Lines of Credit, Credit Stacking, SBA Loans, Real Estate Loans, and Personal Term Loans.'],
      ['How fast can I get funded?','It depends on the product. Revenue Advances can fund in as little as 24-48 hours; Lines of Credit typically take 7 business days; SBA Loans take 2-8 weeks. Most clients see initial offers within minutes.'],
      ...
      ['Can I apply if I have bad credit?','Yes. Several of our products, including the Revenue Advance, have no minimum FICO requirement. Approvals are based on your business performance, not just your credit.'],
...
<section class="py-20 md:py-28">
  ...
  window.LendiagoRenderApply = function(){
    ...
    const formUrl = 'https://form.jotform.com/261857146006154';
    document.getElementById('page-content').innerHTML = `
...
<article>
  ...
  <section class="py-20 md:py-28">
    <div class="container mx-auto px-4 md:px-6 max-w-3xl prose-lendiago">
      ...
      <p>Before signing on any dotted line, run through this short checklist. Match the product's structure to the use case: short-term needs (payroll, inventory) work best with revolving credit or a Revenue Advance. Long-term investments (real estate, acquisitions) deserve longer-term, lower-rate products like Term Loans and SBA Loans.</p>
      ...
      <p>Run your projected repayments against a conservative revenue scenario. If a slow quarter would put you in a cash-flow squeeze, choose a more flexible product (e.g., a revenue-based Revenue Advance over a fixed-payment loan).</p>
      <h2>What's Next</h2>
  ...
  <section class="py-20 bg-muted/30">
    <div class="container mx-auto px-4 md:px-6 max-w-3xl text-center reveal">
      ...
      <a href="https://form.jotform.com/261857146006154" class="inline-flex items-center justify-center bg-primary text-primary-foreground hover:bg-accent rounded-full px-10 py-4 text-lg font-bold transition">Apply Now</a>
    </div>
  </section>
</article>`;
  };
  ...
  <div class="container mx-auto px-4 md:px-6 relative">
    <div class="grid md:grid-cols-12 gap-12 items-center reveal">
      ...
      <div class="md:col-span-5 flex flex-col gap-3 md:items-end">
        <a href="https://form.jotform.com/261857146006154" class="inline-flex items-center justify-center bg-accent text-primary hover:bg-accent/90 rounded-full px-10 py-5 text-base font-bold w-full md:w-auto">Apply Now
